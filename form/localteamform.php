...
/**
 * Form to create Teams with all features.
 *
...
class group_form extends moodleform {
    ...
    public function definition() {
        ...
        $formattosplit = array(
            get_string('byGroups', 'local_classroom_teams'),
            get_string('byStudents', 'local_classroom_teams')
        );

        $personalfilter = array (
            get_string('none', 'local_classroom_teams')
        );
        ...
        $tis = get_string('title_indications', 'local_classroom_teams');
        ...
        $output .= html_writer::start_tag('div', [
            ...
            $output .= html_writer::start_tag('div', array('class' => 'C01', 'id' => 'C01'));
                $output .= html_writer::start_tag('div', array('class' => 'C02', 'id' => 'C02'));
                    ...
                    $output .= html_writer::tag('label', get_string('select_title', 'local_classroom_teams'), [
                        'id' => 'selectTitle',
                    ...
                    $output .= html_writer::start_tag('div',
                    array('class' => 'explain_title_container',
                    'id' => 'explain_title_container'));
                        $output .= html_writer::tag('label', get_string('explain_title', 'local_classroom_teams'), [
            ...
            $output .= html_writer::empty_tag('input', [
                'type' => 'text',
                'placeholder' => get_string('sti', 'local_classroom_teams'),
        ...
        $output .= html_writer::start_tag('div', [
            ...
            $output .= html_writer::start_tag('div', array('class' => 'C1', 'id' => 'C1'));
                ...
                $output .= html_writer::tag('label', get_string('select_course', 'local_classroom_teams'), [
                    'id' => 'selectCurso',
                    'class' => 'ml-6 mr-0 mb-0'
                ]);
                    ...
                    $output .= html_writer::start_tag('div', [
                        ...
                        $output .= html_writer::tag('label', get_string('explain_course', 'local_classroom_teams'), [
        ...
        'class' => 'group_course']);
            $output .= html_writer::start_tag('div', array('id' => 'group_course_container', 'class' => 'group_course_container'));
                ...
                $output .= html_writer::start_tag('div', array('class' => 'C3 d-flex flex-column', 'id' => 'C3'));
                    ...
                    $output .= html_writer::tag('label', get_string('select_group_cour', 'local_classroom_teams'), [
                        'id' => 'select_group',
                        ...
                        $output .= html_writer::start_tag('div', [
                            ...
                            $output .= html_writer::tag('label', get_string('explain_groupcour', 'local_classroom_teams'), [
        ...
        $output .= html_writer::start_tag('div', [
            ...
            $output .= html_writer::start_tag('div', array('class' => 'C5 d-flex flex-column', 'id' => 'C5'));
                ...
                $output .= html_writer::tag('label', get_string('groupsChoises', 'local_classroom_teams'), [
                    'class' => 'ml-6 mb-0',
                    'id' => 'groupsChoises',
                    'name' => 'groupsChoises'
                ]);
                    ...
                    [
                        ...
                        $output .= html_writer::tag('label', get_string('explain_formatsplit', 'local_classroom_teams'), [
        ...
        'class' => 'none byStudent']);
            $output .= html_writer::start_tag('div', array('class' => 'C7 d-flex flex-column', 'id' => 'C7'));
                ...
                $output .= html_writer::tag('label', get_string('manyStudent', 'local_classroom_teams'), [
                    ...
                    $output .= html_writer::start_tag('div', [
                        ...
                        $output .= html_writer::tag(
                            'label',
                            get_string('explain_bystudent', 'local_classroom_teams'),
        ...
        $output .= html_writer::start_tag('div', array('id' => 'byGroup', 'class' => ' none byGroup'));
            ...
            $output .= html_writer::start_tag('div', array('class' => 'C9 d-flex flex-column', 'id' => 'C9'));
                    $output .= html_writer::start_tag('div', array('class' => 'C10', 'id' => 'C10'));
                        $output .= html_writer::tag(
                            'label',
                            get_string('manyGroups', 'local_classroom_teams'),
                        ...
                        $output .= html_writer::start_tag('div', [
                            ...
                            $output .= html_writer::tag(
                                'label',
                                get_string('explain_bygroup', 'local_classroom_teams'),
        ...
        $output .= html_writer::tag('p', get_string('more_filter', 'local_classroom_teams'), [
            ...
            $output .= html_writer::tag('p', get_string("less_filter", 'local_classroom_teams'), [
                'type' => 'button',
        ...
        $output .= html_writer::start_tag('div', [
            ...
            'class' => 'FormatoContainer_history d-flex align-items-center'
                ...
                $output .= html_writer::start_tag('div', [
                    ...
                    'class' => 'history_text_container d-flex justify-content-start'
                ]);
                    ...
                    $output .= html_writer::tag('label', get_string("with_history", 'local_classroom_teams'), [
                        'class' => 'ml-6 mr-1',
                        'id' => 'with_history_label',
                        'name' => 'with_history mb-0'
                    ]);
                        $output .= html_writer::tag('small', get_string("santi", 'local_classroom_teams'), [
                    ...
                    $output .= html_writer::start_tag('div', [
                        ...
                        $output .= html_writer::tag(
                            'label',
                            get_string('explainhisto', 'local_classroom_teams'),
                ...
                $output .= html_writer::empty_tag(
                    ...
                    array(
                        'type' => 'checkbox',
                        'id' => 'with_history',
                        'class' => 'rounded with_history ml-4 mr-3',
                        'disabled' => 'disabled',
                    )
                );
                ...
                $img = html_writer::tag('img', '', array(
                    'alt' => get_string('premiumicon', 'local_classroom_teams'), 'src' => "pix/premiumicon.png", 'height' => 30));
                ...
                'style' => 'width: 20%;'));
                    ...
                    background-image: linear-gradient(to bottom left, #465f9b, #755794, #6d76ae); ']);
                        $output .= $img;
                        $output .= html_writer::tag('label', get_string('getpremium', 'local_classroom_teams'),
        ...
        $output .= html_writer::start_tag('div', [
            ...
            'class' => 'incompatible_checkbox d-flex']);
                $output .= html_writer::tag('label', get_string("tandem", 'local_classroom_teams'), [
                    'class' => 'ml-6 mr-1',
                ...
                $output .= html_writer::start_tag('div', [
                    ...
                    $output .= html_writer::tag('label', get_string('explain_tandem', 'local_classroom_teams'), [
                ...
                $output .= html_writer::empty_tag('input', [
                    ...
                    'class' => 'rounded incompatible_tandem ml-4 mr-3',
        ...
        $output .= html_writer::start_tag('div', [
            ...
            $output .= html_writer::start_tag('div', [
                ...
                'class' => 'filterContainer_cooperative d-flex align-items-start justify-content-start'
            ]);
                 // Personal filter.
                $output .= html_writer::start_tag('div',
                ['id' => 'personal_filter',
                'class' => 'personal_filter d-flex pb-3']);
                    $output .= html_writer::tag('label', get_string('select_personal_filter', 'local_classroom_teams'), [
                    ...
                    $output .= html_writer::start_tag('div', [
                        ...
                        $output .= html_writer::tag('label', get_string('explain_personalfilter', 'local_classroom_teams'), [
                    ...
                    'personal_filter', [
                        ...
                        'class' => 'option_personal_filter w-auto disabled',
                        'disabled' => true
                    ]);
                    ...
                    array(
                        'alt' => get_string('premiumicon', 'local_classroom_teams'),
                        'src' => "pix/premiumicon.png",
                        'height' => 30
                    ));
                    $output .= html_writer::start_tag('a',
                    array(
                        'href' => 'https://lab.eurecatacademy.org',
                        'target' => '_blank',
        ...
        'class' => 'create_refresh mt-5 d-flex justify-content-center align-items-center'));
            $output .= html_writer::start_tag('div',
            ...
            'class' => 'create_refresh_div d-flex justify-content-center align-items-end']);
                $output .= html_writer::empty_tag('input', [
                    ...
                    'id' => 'create_button',
                    'name' => 'create',
                    'value' => get_string("create", 'local_classroom_teams')
                ]);
            $output .= html_writer::end_tag('div');
        $output .= html_writer::end_tag('div');
        ...
        $output .= html_writer::start_tag('div', [
            ...
            $output .= html_writer::start_tag('div', [
                ...
                get_string('pupils', 'local_classroom_teams'),
            ...
            $output .= html_writer::start_tag('div', array('id' => 'output_print', 'class' => 'output_print ml-6 mr-3'));
                ...
                $output .= html_writer::tag('h4', get_string('group_proposal', 'local_classroom_teams'), array('class' => 'titol'));
                ...
                $output .= html_writer::start_tag('div', [
                    ...
                    $output .= html_writer::tag('p', get_string("f_screen", 'local_classroom_teams'), [
                        'type' => 'button',
                        'class' => 'rounded m-0',
                        'id' => 'f_screen',
                        'name' => 'f_screen'
        ...
        $output .= html_writer::start_tag('div', array('name' => 'modal_Cont', 'id' => 'modal_Cont', 'class' => 'modal_Cont '));
            ...
            $output .= html_writer::start_tag('div', array('name' => 'modal_x', 'id' => 'modal_x', 'class' => 'modal_x '));
                $output .= html_writer::tag('label', get_string('x', 'local_classroom_teams'), array('id' => 'x', 'class' => 'x'));
            $output .= html_writer::end_tag('div');
        ...
        'class' => 'save_button m-auto mb-0 mt-5 px-2 py-1 border-0'));
            $output .= html_writer::empty_tag('input', [
                ...
                'id' => 'saveGroups',
                'name' => 'saveGroups',
                'value' => get_string("saveGroups", 'local_classroom_teams')
            ]);
            $output .= html_writer::empty_tag('input', [
                'type' => 'button',
                'class' => 'btn btn-primary rounded save ml-2',
                'id' => 'saveinmoodle',
                'value' => get_string("saveinmoodle", 'local_classroom_teams')
            ]);
            $output .= html_writer::empty_tag('input', [
                'type' => 'button',
                ...
                'id' => 'refresh',
                'name' => 'refresh',
                'value' => get_string("refresh", 'local_classroom_teams')
            ]);
        $output .= html_writer::end_tag('div');
        $output .= html_writer::start_tag('div',
        array('class' => 'mt-3', 'id' => 'managedelcontainer'));
        $output .= html_writer::tag('small',
        get_string('managedeletion', 'local_classroom_teams'),
