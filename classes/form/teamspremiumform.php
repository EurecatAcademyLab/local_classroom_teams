...
class premium_form extends moodleform {
    ...
    public function definition() {
        ...
        $output .= html_writer::tag('h4',
            get_string('premium', 'local_classroom_teams'),
        ...
        $output .= html_writer::tag('p', get_string('nopubli', 'local_classroom_teams'), ['class' => 'text-light']);
        $output .= html_writer::end_tag('li');
        $output .= html_writer::start_tag('li', array('style' => 'list-style-type: none;'));
        $output .= html_writer::tag('p', get_string('keepquarentine', 'local_classroom_teams'), ['class' => 'text-light']);
        $output .= html_writer::end_tag('li');
        $output .= html_writer::start_tag('li', array('style' => 'list-style-type: none;'));
        $output .= html_writer::tag('p', get_string('removequarentine', 'local_classroom_teams'), ['class' => 'text-light']);
        $output .= html_writer::end_tag('li');
        $output .= html_writer::start_tag('li', array('style' => 'list-style-type: none;'));
        $output .= html_writer::tag('p', get_string('desblockhistory', 'local_classroom_teams'), ['class' => 'text-light']);
        $output .= html_writer::end_tag('li');
        $output .= html_writer::start_tag('li', array('style' => 'list-style-type: none;'));
        $output .= html_writer::tag('p', get_string('desblockpersonal', 'local_classroom_teams'), ['class' => 'text-light']);
        $output .= html_writer::end_tag('li');
        $output .= html_writer::start_tag('li', array('style' => 'list-style-type: none;'));
        $output .= html_writer::tag('p', get_string('desblocktandem', 'local_classroom_teams'), ['class' => 'text-light']);
        $output .= html_writer::end_tag('li');
        $output .= html_writer::start_tag('li', array('style' => 'list-style-type: none', 'class' => 'mb-4'));
        $output .= html_writer::tag('p', get_string('exportdata', 'local_classroom_teams'), ['class' => 'text-light']);
        $output .= html_writer::end_tag('li');
        ...
        $options = ['class' => 'hatebtn', 'target' => '_blank'];
            $output .= $OUTPUT->single_button($url,
                get_string('premiumpage', 'local_classroom_teams'), 'post', $options);
        $output .= html_writer::end_tag('div');
        $output .= html_writer::end_tag('div');
        $output .= html_writer::end_tag('div');
