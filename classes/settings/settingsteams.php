...
$plugin = 'local_classroom_teams';
$name = 'status';
$existingrecordteams = $DB->get_record('config_plugins', array('plugin' => $plugin, 'name' => $name));

if ($existingrecordteams) {
    $record = $existingrecordteams;
    $record->value = $status;
